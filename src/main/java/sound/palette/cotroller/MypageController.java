...
public class MypageController {
	...
	public ModelAndView mypageimage(CommandMap commandMap, HttpServletRequest request) throws Exception {
	...
	public void mypagememberdelete(HttpServletRequest request, HttpServletResponse response, CommandMap commandMap)
			throws Exception {
		HttpSession session = request.getSession(false);
		...
		out.println("<script>alert('다음에 다시 뵙겠습니다!');location.href='/palette/SOPA/loginForm/';</script>");
